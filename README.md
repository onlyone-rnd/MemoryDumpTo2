...
**MemoryDumpTo** is an x64dbg plugin that allows you to save and convert memory dumps into source-ready data declarations for multiple programming languages and assembler syntaxes.
...
![](https://github.com/onlyone-rnd/MemoryDumpTo2/blob/main/demo/demo.webm)
